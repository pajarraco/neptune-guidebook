...
export default function CodeEntryModal({ onCodeVerified, requiredCode }: CodeEntryModalProps) {
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        <div className="modal-header">
          <span className="material-symbols-outlined" style={{ fontSize: '3rem', color: 'var(--primary-color)' }}>
            lock
          </span>
        ...
        <form onSubmit={handleSubmit} className="code-entry-form">
          ...
          <button type="submit" className="submit-button">
            <span className="material-symbols-outlined" style={{ fontSize: '1.25rem', verticalAlign: 'middle', marginRight: '0.5rem' }}>
              check_circle
            </span>
            Access Guidebook
          </button>

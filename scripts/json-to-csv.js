...
rows.push([
  ...
  escapeCSV(data.welcome.featuresSection.title),
]);
rows.push([
  "welcome_features_answer",
  escapeCSV(data.welcome.featuresSection.answer),
]);
rows.push([
  "welcome_features_description",
  escapeCSV(data.welcome.featuresSection.description),
]);
...
rows.push([
  "welcome_features_note",
  escapeCSV(data.welcome.featuresSection.note),
]);

// Add to phone
rows.push([
  "welcome_add_to_phone_icon",
  escapeCSV(data.welcome.addToPhone.icon),
]);
rows.push([
  "welcome_add_to_phone_title",
  escapeCSV(data.welcome.addToPhone.title),
]);
...
// Meet your team
rows.push([
  "welcome_meet_team_title",
  escapeCSV(data.welcome.meetYourTeam.title),
]);
rows.push([
  "welcome_meet_team_photo",
  escapeCSV(data.welcome.meetYourTeam.photoPlaceholder),
]);
rows.push([
  "welcome_host_icon",
  escapeCSV(data.welcome.meetYourTeam.hostWelcome.icon),
]);
rows.push([
  "welcome_host_title",
  escapeCSV(data.welcome.meetYourTeam.hostWelcome.title),
]);
rows.push([
  "welcome_host_description",
  escapeCSV(data.welcome.meetYourTeam.hostWelcome.description),
]);
rows.push([
...
// Founder note
rows.push([
  "welcome_founder_icon",
  escapeCSV(data.welcome.meetYourTeam.founderNote.icon),
]);
rows.push([
  "welcome_founder_title",
  escapeCSV(data.welcome.meetYourTeam.founderNote.title),
]);
rows.push([
  "welcome_founder_message",
  escapeCSV(data.welcome.meetYourTeam.founderNote.message),
]);
rows.push([
  "welcome_founder_mission",
  escapeCSV(data.welcome.meetYourTeam.founderNote.mission),
]);
rows.push([
  "welcome_founder_closing",
  escapeCSV(data.welcome.meetYourTeam.founderNote.closing),
]);
...
rows.push([
  "property_wifi_network_label",
  escapeCSV(data.propertyInfo.wifi.networkLabel),
]);
rows.push([
  "property_wifi_password_label",
  escapeCSV(data.propertyInfo.wifi.passwordLabel),
]);
rows.push(["property_wifi_network", escapeCSV(data.propertyInfo.wifi.network)]);
rows.push([
  "property_wifi_password",
  escapeCSV(data.propertyInfo.wifi.password),
]);
rows.push(["property_checkin_time", escapeCSV(data.propertyInfo.checkIn)]);
rows.push([
  "property_checkin_label",
  escapeCSV(data.propertyInfo.checkInLabel),
]);
rows.push(["property_checkout_time", escapeCSV(data.propertyInfo.checkOut)]);
rows.push([
  "property_checkout_label",
  escapeCSV(data.propertyInfo.checkOutLabel),
]);
...
rows.push([
  ...
  escapeCSV(data.checkInOut.sectionTitle),
]);
rows.push(["checkin_title", escapeCSV(data.checkInOut.checkIn.title)]);
rows.push([
  "checkin_subheading",
  escapeCSV(data.checkInOut.checkIn.subheading),
]);
rows.push([
  "checkin_arriving_early_label",
  escapeCSV(data.checkInOut.checkIn.arrivingEarlyLabel),
]);
...
rows.push([
  "checkout_subheading",
  escapeCSV(data.checkInOut.checkOut.subheading),
]);
...
rows.push([
  "transport_please_note_label",
  escapeCSV(data.transport.pleaseNoteLabel),
]);

// Amenities
rows.push([
  "amenities_section_title",
  escapeCSV(data.amenitiesSection.sectionTitle),
]);
rows.push([
  "amenities_service_info_label",
  escapeCSV(data.amenitiesSection.serviceInfoLabel),
]);
rows.push([
  "amenities_how_to_use_label",
  escapeCSV(data.amenitiesSection.howToUseLabel),
]);
rows.push([
  "amenities_help_tip_title",
  escapeCSV(data.amenitiesSection.helpTip.title),
]);
rows.push([
  "amenities_help_tip_message",
  escapeCSV(data.amenitiesSection.helpTip.message),
]);

// Local guide
rows.push([
  "localguide_section_title",
  escapeCSV(data.localGuide.sectionTitle),
]);
rows.push([
  "localguide_view_on_maps_label",
  escapeCSV(data.localGuide.viewOnMapsLabel),
]);
rows.push([
  "localguide_packing_list_intro",
  escapeCSV(data.localGuide.packingListIntro),
]);
...
rows.push([
  "emergency_freshwater_label",
  escapeCSV(data.emergency.freshwaterLabel),
]);
rows.push([
  "emergency_address_note_label",
  escapeCSV(data.emergency.addressNoteLabel),
]);
...
rows.push([
  "emergency_safety_info_title",
  escapeCSV(data.emergency.safetyInfo.title),
]);
...
if (data.emergency.waterSafety) {
  rows.push([
    "emergency_water_safety_title",
    escapeCSV(data.emergency.waterSafety.title),
  ]);
  rows.push([
    "emergency_water_safety_beaches",
    escapeCSV(data.emergency.waterSafety.beaches),
  ]);
  rows.push([
    "emergency_water_safety_freshwater",
    escapeCSV(data.emergency.waterSafety.freshwater),
  ]);
}
...
data.emergency.contacts.forEach((contact, i) => {
  ...
  if (contact.address)
    rows.push([
      `emergency_contact_${i + 1}_address`,
      escapeCSV(contact.address),
    ]);
  if (contact.hours)
    rows.push([`emergency_contact_${i + 1}_hours`, escapeCSV(contact.hours)]);
  if (contact.note)
    rows.push([`emergency_contact_${i + 1}_note`, escapeCSV(contact.note)]);
});

// Transport - Parking
if (data.transport.parking) {
  rows.push([
    "transport_parking_title",
    escapeCSV(data.transport.parking.title),
  ]);
  rows.push([
    "transport_parking_description",
    escapeCSV(data.transport.parking.description),
  ]);
}
...
if (data.transport.rideshare) {
  rows.push([
    "transport_rideshare_title",
    escapeCSV(data.transport.rideshare.title),
  ]);
  rows.push([
    "transport_rideshare_description",
    escapeCSV(data.transport.rideshare.description),
  ]);
}
...
if (data.transport.publicTransport) {
  rows.push([
    "transport_public_title",
    escapeCSV(data.transport.publicTransport.title),
  ]);
  rows.push([
    "transport_public_description",
    escapeCSV(data.transport.publicTransport.description),
  ]);
  rows.push([
    "transport_public_info",
    escapeCSV(data.transport.publicTransport.info),
  ]);
  rows.push([
    "transport_public_fares",
    escapeCSV(data.transport.publicTransport.fares),
  ]);
  if (data.transport.publicTransport.limitations) {
    rows.push([
      "transport_public_limitations",
      escapeCSV(data.transport.publicTransport.limitations),
    ]);
  }
}
...
if (data.transport.airportTransfers) {
  rows.push([
    "transport_airport_title",
    escapeCSV(data.transport.airportTransfers.title),
  ]);
  rows.push([
    "transport_airport_description",
    escapeCSV(data.transport.airportTransfers.description),
  ]);
  data.transport.airportTransfers.options.forEach((option, i) => {
    rows.push([
      `transport_airport_option_${i + 1}_name`,
      escapeCSV(option.name),
    ]);
    if (option.phone)
      rows.push([
        `transport_airport_option_${i + 1}_phone`,
        escapeCSV(option.phone),
      ]);
    rows.push([
      `transport_airport_option_${i + 1}_type`,
      escapeCSV(option.type),
    ]);
  });
  if (data.transport.airportTransfers.note) {
    rows.push([
      "transport_airport_note",
      escapeCSV(data.transport.airportTransfers.note),
    ]);
  }
}
...
if (data.transport.carRental) {
  rows.push([
    "transport_car_rental_title",
    escapeCSV(data.transport.carRental.title),
  ]);
  rows.push([
    "transport_car_rental_description",
    escapeCSV(data.transport.carRental.description),
  ]);
  if (data.transport.carRental.note) {
    rows.push([
      "transport_car_rental_note",
      escapeCSV(data.transport.carRental.note),
    ]);
  }
}
...
// House Rules
rows.push([
  "house_rules_important_note_title",
  escapeCSV(data.houseRules.importantNote.title),
]);
rows.push([
  "house_rules_important_note_message",
  escapeCSV(data.houseRules.importantNote.message),
]);
...
data.amenities.forEach((amenity, i) => {
  ...
  if (amenity.instructions)
    rows.push([
      `amenity_${i + 1}_instructions`,
      escapeCSV(amenity.instructions),
    ]);
  if (amenity.serviceInfo)
    rows.push([
      `amenity_${i + 1}_service_info`,
      escapeCSV(amenity.serviceInfo),
    ]);
...
if (data.localGuide.packingList) {
  rows.push([
    "local_guide_packing_list_title",
    escapeCSV(data.localGuide.packingList.title),
  ]);
...
data.localGuide.recommendations.forEach((rec, i) => {
  ...
  if (rec.address)
    rows.push([`local_rec_${i + 1}_address`, escapeCSV(rec.address)]);
  if (rec.distance)
    rows.push([`local_rec_${i + 1}_distance`, escapeCSV(rec.distance)]);
...
if (data.common) {
  rows.push([
    "common_everything_you_need",
    escapeCSV(data.common.everythingYouNeed),
  ]);
...
console.log(`\n📊 Data included:`);
console.log(
  `   - Welcome features: ${data.welcome.featuresSection.features.length}`,
);
console.log(
  `   - Team members: ${data.welcome.meetYourTeam.hostWelcome.teamMembers.length}`,
);
...
console.log(
  `   - Local recommendations: ${data.localGuide.recommendations.length}`,
);
